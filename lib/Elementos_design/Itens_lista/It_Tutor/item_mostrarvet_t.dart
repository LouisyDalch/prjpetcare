...
class ItemMostrarVetT extends StatefulWidget {
  const ItemMostrarVetT({super.key});

  @override
  State<ItemMostrarVetT> createState() => _ItemMostrarVetTState();
}

class _ItemMostrarVetTState extends State<ItemMostrarVetT> {
  @override
