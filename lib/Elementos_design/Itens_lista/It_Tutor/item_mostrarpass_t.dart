...
class ItemMostrarPassT extends StatefulWidget {
  const ItemMostrarPassT({super.key});

  @override
  State<ItemMostrarPassT> createState() => _ItemMostrarPassTState();
}

class _ItemMostrarPassTState extends State<ItemMostrarPassT> {
  @override
