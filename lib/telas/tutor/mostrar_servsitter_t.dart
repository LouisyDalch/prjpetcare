...
import '../../Elementos_design/Itens_lista/It_Tutor/item_mostrarsitter_t.dart';
import '../../Elementos_design/design.dart';
import '../../Elementos_design/Itens_lista/It_Tutor/item_feedback_cuid_t.dart';

class MostrarServPetSitter_T extends StatefulWidget {
  const MostrarServPetSitter_T({super.key});

  @override
  State<MostrarServPetSitter_T> createState() => _MostrarServPetSitter_TState();
}

class _MostrarServPetSitter_TState extends State<MostrarServPetSitter_T> {
  String pesquisa = "";
  final lst = ["um", "2", "três"];
  @override
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text("Pet Sitters", style: TextStyle(
                  ...
                  Container(
                    ...
                    child: ListView.builder(
                                ...
                                itemBuilder: (context, Index) {
                                  return const ItemMostrarPetSitterT();
                                }),
                  ),
