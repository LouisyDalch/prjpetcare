...
class VisualizacaoPet_T extends StatefulWidget {
  ...
  VisualizacaoPet_T({required this.text});
...
class _VisualizacaoPet_TState extends State<VisualizacaoPet_T> {
  ...
  void initState(){
    ...
    if(widget.text.length > 100){
      ptUm = widget.text.substring(0,100);
      ptDois = widget.text.substring(100, widget.text.length);
    }else{
      ptUm = widget.text;
      ptDois = "";
    }
                                ...
                                children: <Widget>[
                                  ...
                                  InkWell(
                                    child: Row(
                                      ...
                                      children: <Widget>[
                                        Text(
                                          mais ? "mostrar mais" : "mostrar menos",
                                          style: TextStyle(color: Color.fromRGBO(219, 114, 38, 1),
